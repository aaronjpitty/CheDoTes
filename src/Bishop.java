...
public class Bishop extends Piece{
	public Bishop(Boolean colour, int xp, int yp){
	...
	//generic Bishop move method, only diagonal but as can go
	public static String[] move(int x1, int y1){
		String [] possibleInd = new String[40];
		for(int i = 0; i < 8; i++){
			...
			possibleInd[i] = possx1 + "," + possy1;
			possibleInd[i+16] = possx1 + "," + possy2;
			possibleInd[i+24] = possx2 + "," + possy1;
			possibleInd[i+32] = possx2 + "," + possy2;
